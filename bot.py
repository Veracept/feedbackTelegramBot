...
async def start(message: types.Message):
	...
	if result[0] == 0:
		if message.chat.id == admin:
			...
			await message.answer('Привет, друг👋.\n ᅠᅠᅠᅠᅠᅠᅠ \nЭто бот обратной связи VStudio, мы занимаемся созданием превью, баннеров,аватарок,шапок, сайтов, веб-приложений и ботов в Discord и Telegram 👨🏻‍💻 ! \n ᅠᅠᅠᅠᅠᅠᅠ \nЗа спам/флуд - вы можете получить как временный, так и вечный ЧС🔒! \n ᅠᅠᅠᅠᅠᅠᅠ \nЧто бы создать ваш заказ напишите что-нибудь и отправьте боту 💻.')
	else:
